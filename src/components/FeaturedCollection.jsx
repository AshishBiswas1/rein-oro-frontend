...
export default function FeaturedCollection({ products = [] }) {
 ...
 return (
  <section className="py-24 bg-rein-charcoal border-y border-rein-gold-dim/20">
   <div className="max-w-7xl mx-auto px-6">
    {/* Section Header */}
    <div className="text-center mb-16">
     <h2 className="font-display text-4xl md:text-5xl text-rein-cream mb-4">
      Curated Selections
     </h2>
     <p className="text-rein-gold-primary tracking-widest uppercase text-sm font-semibold">
