...
export default function AddProductPage() {
 ...
 // Dynamic Variants State (Weight + Price + Stock)
 const [variants, setVariants] = useState([
  { weight: "100g", price: "", stock: "" },
 ]);

 // Dynamic Ingredients State (Tabular Composition)
 ...
 const handleSubmit = async (e) => {
  ...
  try {
   let downloadUrl = "/images/placeholder.jpg";

   // 1. Upload logic to your Next.js API
   if (imageFile) {
   ...
   // Calculate aggregate stock so older components (like ProductCard) don't crash
   ...
   setError(
    err.message || "Failed to save the product. Please check your connection.",
   );
   setIsSubmitting(false);
  }
 };
   ...
   <form onSubmit={handleSubmit} className="space-y-8">
    ...
    <div className="flex justify-end gap-4">
     ...
     >
      ...
      {isSubmitting ? "Uploading Asset..." : "Save Product"}
     </button>
    </div>
   </form>
  </div>
