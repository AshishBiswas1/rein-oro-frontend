...
export default async function ShopPage() {
 ...
 return (
  <main className="bg-[#0A0A0A] min-h-screen flex flex-col pb-24">
   ...
   {/* Hero Header Section */}
   <header className="pt-40 pb-16 px-6 max-w-7xl mx-auto text-center w-full relative">
    ...
    <h1 className="relative font-display text-[42px] md:text-[52px] text-[#F5EDD6] leading-tight italic">
     Curated Purity
    </h1>
    <div className="relative w-12 h-[1px] bg-[#C9A84C]/40 mt-8 mx-auto" />
    <p className="relative mt-8 max-w-2xl mx-auto text-[#9A9485] font-ui text-sm leading-relaxed">
   ...
   {/* Main Catalog Grid */}
   <section className="px-6 max-w-7xl mx-auto w-full flex-1">
